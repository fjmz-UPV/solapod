...
let nuevo_principal = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "APOD NASA"), /*#__PURE__*/React.createElement("h2", {
  id: "titulo"
}, "T\xEDtulo: ", /*#__PURE__*/React.createElement("span", null)), /*#__PURE__*/React.createElement("img", {
  id: "foto"
  ...
  id: "fecha",
  className: "concepto"
}, "Fecha: ", /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("input", {
  type: "date",
  id: "calendario",
  onChange: e => {
    /*buscar_foto(e.target.value);*/cambio_fecha(e.target.value);
  ...
  id: "autor",
  className: "concepto"
}, "Autor: ", /*#__PURE__*/React.createElement("span", null))), /*#__PURE__*/React.createElement("div", {
  id: "descripcion",
  className: "concepto"
}, "Descripci\xF3n: ", /*#__PURE__*/React.createElement("span", null)));
...
async function cambio_fecha(fecha) {
  ...
  let dia_elegido = nueva_fotos_semana_info.find(dia => {
    if (dia.date == fecha) return dia;
  });
...
class Foto_fecha extends React.Component {
  render() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      id: "foto-" + this.props.info_dia.date,
      src: this.props.info_dia.url,
      onClick: e => {
        actualizar_pagina(this.props.info_dia);
      }
    }), /*#__PURE__*/React.createElement("p", {
      className: "fecha"
    }, this.props.info_dia.date));
  }
}
...
class Mosaico extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      fotos_semana_info: this.props.fotos_semana_info.slice()
    });
  }
  ...
  cambioSemana(fotos_semana_info) {
    this.setState({
      fotos_semana_info: fotos_semana_info.slice()
    });
  }
  ...
  render() {
    ...
    let mosaico = this.state.fotos_semana_info.map((info_dia, idx) => /*#__PURE__*/React.createElement(Foto_fecha, {
      key: idx,
      info_dia: info_dia
    }));
    return mosaico;
...
async function print_mosaico() {
  ...
  let ElemMosaico = /*#__PURE__*/React.createElement(Mosaico, {
    fotos_semana_info: fotos_semana_info
  });
